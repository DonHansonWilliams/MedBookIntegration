...
class Preauth(models.Model):
    preauth_id = models.AutoField(primary_key=True, null=False, max_length=100)
    ...
    requested_amount = models.DecimalField(null=False, max_digits=15, decimal_places=2)
    ...
    request_notes = models.CharField(null=True, max_length=100)
    requested_by = models.CharField(null=True, max_length=100)
